...
>   3. [Getting Started with OneSpace (Tutorials)](#tutorials-)<br>
    ...
    ii) - [Training a Classification Model](#clf-)<br>
    B ) - [Computer Vision](#cv-)<br>
    i ) - [Training an Image Classification Model with Tensorflow](#tf-imgclf)<br>
...
#### ii) - Training a Classification Model :<a id='clf-'></a>
First step is to setup the initial directory. This should present a following tree structure at the beginning of the training:
```bash
│   .env
│   tabularConfig.py
...
#### i) - Training an Image Classification Model with Tensorflow :<a id='tf-imgclf'></a>
First step is to setup the initial directory. This should present a following tree structure at the beginning of the training:
```bash
│   .env
│   tensorflowConfig.py
...
#### ii) - Training an Image Classification Model with PyTorch :<a id='pytorch-imgcls'></a>
First step is to setup the initial directory. This should present a following tree structure at the beginning of the training:
```bash
│   .env
│   pytorchConfig.py
